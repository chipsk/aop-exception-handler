...
@Component
@HandlerType(value = ErrorTag.RETRY)
@Slf4j
public class RetryErrorHandler extends AbstractHandler {

    @Override
    public Object handle(ErrorRequest request) {
        System.out.println("retryError: " + request.getErrorException().toString());
        return null;
    }
}
